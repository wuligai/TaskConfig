 ...
 */
let config = {
    darksky_api: "a2d3e35739054198e70d6b8132d99d95", //从https://darksky.net/dev/ 上申请key填入即可
    aqicn_api: "5092bda2287a45b9413a22ea8fe1eaa1b3827d7d", //从http://aqicn.org/data-platform/token/#/ 上申请key填入即可
    huweather_apiKey: "https://free-api.heweather.net/s6/weather/{weather-type}?{parameters}", //和风天气APIkey,可自行前往 https://dev.heweather.com/ 进行获取
    lat_lon: "38.718178, 114.362918", //请填写经纬度,直接从谷歌地图中获取即可
